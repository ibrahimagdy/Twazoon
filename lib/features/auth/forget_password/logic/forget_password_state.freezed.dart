...
class __$$ForgetPasswordLoadingImplCopyWithImpl<T, $Res>
    extends
        _$ForgetPasswordStateCopyWithImpl<
          T,
          $Res,
...
class _$ForgetPasswordSuccessImpl<T> implements ForgetPasswordSuccess<T> {
  const _$ForgetPasswordSuccessImpl();
...
abstract class ForgetPasswordSuccess<T> implements ForgetPasswordState<T> {
  const factory ForgetPasswordSuccess() = _$ForgetPasswordSuccessImpl<T>;
}

/// @nodoc
abstract class _$$ForgetPasswordErrorImplCopyWith<T, $Res> {
  factory _$$ForgetPasswordErrorImplCopyWith(
    _$ForgetPasswordErrorImpl<T> value,
...
class __$$ForgetPasswordErrorImplCopyWithImpl<T, $Res>
    extends
        _$ForgetPasswordStateCopyWithImpl<T, $Res, _$ForgetPasswordErrorImpl<T>>
    implements _$$ForgetPasswordErrorImplCopyWith<T, $Res> {
  __$$ForgetPasswordErrorImplCopyWithImpl(
    _$ForgetPasswordErrorImpl<T> _value,
...
class _$ForgetPasswordErrorImpl<T> implements ForgetPasswordError<T> {
  ...
  get copyWith =>
      __$$ForgetPasswordErrorImplCopyWithImpl<T, _$ForgetPasswordErrorImpl<T>>(
        this,
        _$identity,
      );
...
abstract class ForgetPasswordError<T> implements ForgetPasswordState<T> {
  const factory ForgetPasswordError({required final ApiErrorModel error}) =
      _$ForgetPasswordErrorImpl<T>;
